from plotAQI import avg_data_2013,avg_data_2014,avg_data_2015,avg_data_2016,avg_data_2017
import requests
import sys
import pandas as pd
...
if __name__ == "__main__":
    ...
    data_2013 = data_combine(2013, 800)
    data_2014 = data_combine(2014, 800)
    data_2015 = data_combine(2015, 800)
    data_2016 = data_combine(2016, 800)
    data_2017 = data_combine(2017, 800)
    #data_2018 = data_combine(2018, 800)
